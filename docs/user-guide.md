...
- Enter your contact's ZTalk ID (peer UID) directly and send the request.
...
- If you choose to erase message history, ZTalk will attempt a secure wipe of local storage. The speed and method may vary depending on your drive type (SSD vs. HDD).
...
- To restore on another device: copy your exported data to the APPDATA/Roaming/ZTalk folder, start ZTalk, and enter your saved passphrase.
